...
async def on_afk(event):
    ...
    if borg.storage.USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        msg = None
        message_to_reply = f"`Kaal Is Ofline Now,He Will Reply You Soon Don't Worry😍 Do you want to see KAAL>`https://instagram.com/i.am.astitva.singh?igshid=1j6rjktbpu0ct\n\n**Last Seen: Only God Knows.*< + \
            f"\n\n__Reason:__ {reason}" \
            if reason \
